    ...
    <div className="p-0 overflow-hidden mx-auto w-[100%] h-screen max-sm:h-auto">
      <div className="flex justify-center items-center gap-0 w-[100%] max-sm:flex-col">
        <div className="w-[30%] h-screen bg-white flex-wrap flex flex-col max-sm:w-[100%]">
             ...
             <p className="mx-14 text-justify font-bold max-sm:mx-auto max-sm:text-center">We provide best house in affordable prices.Here register your account and explore houses. We provide also listening option to user so you can also post the listening to sell the houses.</p>
