    ...
    <div className="p-0 overflow-y-hidden mx-auto w-[100%] h-screen max-sm:h-auto">
      <div className="flex justify-center items-center gap-0 w-[100%] overflow-y-hidden max-sm:flex-col">
        <div className="w-[30%] h-screen bg-white flex-wrap flex flex-col max-sm:w-[100%]">
          ...
          <h1 className="p-4 mt-8 text-2xl font-serif font-bold leading-relaxed text-green-600 text-center max-sm:p-0">
            Welcome Back !
          </h1>
          <p className="mx-14 text-justify font-bold max-sm:mx-auto max-sm:text-center max-sm:mt-5">
          ...
          <img
            ...
            alt=""
            className="w-[100px] mx-14 h-[150px] mt-5"
          />
        </div>
